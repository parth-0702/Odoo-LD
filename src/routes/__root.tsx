...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GlobeTrotter — Personalized multi-city trip planning" },
      {
        name: "description",
        content:
          "Design multi-city journeys, day-by-day itineraries and budgets you can actually trust.",
      },
      { property: "og:title", content: "GlobeTrotter" },
      {
        property: "og:description",
        content: "Plan the journey. Live the story.",
      },
